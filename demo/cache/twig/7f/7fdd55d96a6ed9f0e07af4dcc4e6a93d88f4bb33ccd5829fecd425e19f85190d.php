...
class __TwigTemplate_c7bae3713b22834f8243f40dfc1243873e4220f21bfbf29b3b91559ad18255ac extends Twig_Template
{
...
";
        // line 11
        if ($this->getAttribute($this->getAttribute((isset($context["particle"]) ? $context["particle"] : null), "bootstrap3", array()), "enabled", array())) {
            // line 12
            echo "    ";
            $this->getAttribute((isset($context["gantry"]) ? $context["gantry"] : null), "load", array(0 => "bootstrap.3"), "method");
        } elseif ($this->getAttribute($this->getAttribute(        // line 13
(isset($context["particle"]) ? $context["particle"] : null), "bootstrap2", array()), "enabled", array())) {
            // line 14
            echo "    ";
...
{% if particle.mootools.enabled %}
    ...
    {% endif %}
{% endif %}
", "@particles/frameworks.html.twig", "/var/www/vhosts/smartboater.ca/httpdocs/demo/user/plugins/gantry5/engines/nucleus/particles/frameworks.html.twig");
    }
}
