        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            if (($this->getAttribute($context["item"], "layout", array()) == "header")) {
                ...
                if ($this->getAttribute($context["item"], "content_title", array())) {
                    echo twig_escape_filter($this->env, (isset($context["particle_item_title"]) ? $context["particle_item_title"] : null), "html", null, true);
                }
                // line 26
                echo "                        ";
                if ($this->getAttribute($context["item"], "author", array())) {
                    echo twig_escape_filter($this->env, (isset($context["particle_item_author"]) ? $context["particle_item_author"] : null), "html", null, true);
                }
                // line 27
                echo "                        ";
                if ($this->getAttribute($context["item"], "created_date", array())) {
                    echo twig_escape_filter($this->env, (isset($context["particle_item_created_date"]) ? $context["particle_item_created_date"] : null), "html", null, true);
                }
                // line 28
                echo "                    ";
            }
...
{% endblock %}
", "@particles/simplecontent.html.twig", "/var/www/vhosts/smartboater.ca/httpdocs/demo/user/themes/rt_protean/particles/simplecontent.html.twig");
    }
}
