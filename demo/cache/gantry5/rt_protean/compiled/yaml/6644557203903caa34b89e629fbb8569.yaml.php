...
return [
    ...
    'filename' => '/var/www/vhosts/smartboater.ca/httpdocs/grav-skeleton-protean-site/user/data/gantry5/themes/rt_protean/config/_error/layout.yaml',
    'modified' => 1483473130,
    'data' => [
        'version' => 2,
        'preset' => [
        ...
        'content' => [
            ...
            'system-content-3192' => [
                'block' => [
                    'class' => 'g-error nomarginbottom',
                    'variations' => 'center box1'
                ]
            ]
        ]
    ]
