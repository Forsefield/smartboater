...
return [
    ...
    'filename' => '/var/www/vhosts/smartboater.ca/httpdocs/demo/user/data/gantry5/themes/rt_protean/config/menu/mainmenu.yaml',
    'modified' => 1483473130,
    'data' => [
        'settings' => [
            'title' => 'Mainmenu'
 ...
 <div class="g-block">
        <div class="g-content">
            <a href="?presets=preset6">
                <img src="gantry-media://rocketlauncher/styles/preset6.jpg" alt="Preset 6">
                <br>
                <span>Preset 6</span>
            </a>
        </div>
            ...
            'category/blog/protean-template-suited-for-multiple-websites' => [
                'enabled' => true,
                'anchor_class' => ''
            ],
            'category/blog/exclusive-slider-carousel-and-flipster-particles' => [
                'enabled' => true,
                'anchor_class' => ''
            ],
            'category/blog/customize-content-quickly-in-layout-manager' => [
                'enabled' => true,
                'anchor_class' => ''
            ]
        ]
