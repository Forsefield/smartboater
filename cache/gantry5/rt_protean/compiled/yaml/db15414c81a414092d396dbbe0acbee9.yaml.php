...
return [
    ...
    'filename' => '/var/www/vhosts/smartboater.ca/httpdocs/user/data/gantry5/themes/rt_protean/config/menu/mainmenu.yaml',
    'modified' => 1484941930,
    'data' => [
        'settings' => [
            'title' => 'Mainmenu'
        ...
        'items' => [
            ...
            'pleasure-craft/angler' => [
                'enabled' => true,
                'anchor_class' => ''
            ],
            'pleasure-craft/paddler' => [
                'enabled' => true,
                'anchor_class' => ''
            ],
            'pleasure-craft/power-boat' => [
                'enabled' => true,
                'anchor_class' => ''
            ],
            'pleasure-craft/pwc' => [
